...
int main(){
    ...
    std::ifstream file("../DATASETS/TDrive.txt");
    if (!file) {
    ...
    while (std::getline(file, line)) {
        ...
        unsigned long long encoded_temp = tst.time_encoder(year, month, day, hour);
        unsigned long long encoded_spat = tst.space_encoder(latitude, longitude);
        ...
        tst.Insert(encoded_temp, encoded_spat, lineNum++);
    ...
    std::cout << "====== T-Drive: Trie Construction =====" << std::endl;
    ...
    std::cout << "====== T-Drive: Query Execution =====" << std::endl;
    // Example Query 1:
    unsigned long long timeWindow_start1 = tst.time_encoder(2008, 2, 3, 0);
    unsigned long long timeWindow_end1 = tst.time_encoder(2008, 2, 3, 1);
    std::vector<double> spatialWindow_leftBottom1 = {39.914, 116.323};
    std::vector<double> spatialWindow_rightUpper1 = {39.920, 116.330};
    ...
    // Example Query 2:
    unsigned long long timeWindow_start2 = tst.time_encoder(2008, 2, 3, 0);
    unsigned long long timeWindow_end2 = tst.time_encoder(2008, 2, 3, 6);
    std::vector<double> spatialWindow_leftBottom2 = {39.912, 116.322};
    std::vector<double> spatialWindow_rightUpper2 = {39.921, 116.340};
    ...
    // Example Query 3:
    unsigned long long timeWindow_start3 = tst.time_encoder(2008, 2, 3, 0);
    unsigned long long timeWindow_end3 = tst.time_encoder(2008, 2, 4, 0);
    std::vector<double> spatialWindow_leftBottom3 = {39.913, 116.321};
    std::vector<double> spatialWindow_rightUpper3 = {39.922, 116.365};
